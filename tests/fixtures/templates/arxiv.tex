...
\begin{center}
{\Large \textbf{ Your Paper Title: A Comprehensive Study of \\ Something Important in Your Field }}
\par\vspace{1em}
...
Let $x \in \mathbb{R}^n$ denote the input and $y \in {0, 1}$ the target label. We seek a function $f: \mathbb{R}^n \to {0, 1}$ that minimizes the expected loss:
...
\textbf{Proof.} The proof proceeds in three steps. First, we establish... $square$
...
\bibitem{ref1} {\small Smith, A., Johnson, B., and Williams, C. "Title of the first paper." In \textit{Proceedings of Conference Name}, pages 1-10, 2023.}
\bibitem{ref2} {\small Jones, D. and Lee, E. "Title of the second paper." \textit{Journal Name}, 42(3):123-145, 2023.}
\bibitem{ref3} {\small Chen, F., et al. "Foundational paper title." In \textit{NeurIPS}, 2022.}
\bibitem{ref4} {\small Garcia, G. and Martinez, H. "Baseline method paper." In \textit{ICML}, pages 500-510, 2023.}
\bibitem{ref5} {\small Brown, I., et al. "Another baseline paper." \textit{JMLR}, 24:1-25, 2024. }
\end{thebibliography}
