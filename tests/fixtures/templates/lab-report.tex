...
\par\vspace{2cm}
{\LARGE \textbf{ Laboratory Report: \\ Determination of the Acceleration Due to Gravity \\ Using a Simple Pendulum }}
\par\vspace{2cm}
{\normalsize Course: PHYS 101 - Introduction to Physics \\ Lab Section: Tuesday 2:00 PM }
\par\vspace{1.5cm}
{\normalsize \textbf{Submitted by:} \\ Your Name \\ Student ID: 123456789 }
\par\vspace{1cm}
{\normalsize \textbf{Lab Partner(s):} \\ Partner Name }
\par\vspace{1cm}
{\normalsize \textbf{Instructor:} \\ Dr. Professor Name }
\par\vspace{1.5cm}
{\normalsize \textbf{Date Performed:} November 15, 2024 \\ \textbf{Date Submitted:} November 22, 2024 }
\end{center}
...
\bibitem{ref1} {\small Halliday, D., Resnick, R., and Walker, J. \textit{Fundamentals of Physics}, 11th ed. Wiley, 2018.}
\bibitem{ref2} {\small Taylor, J. R. \textit{An Introduction to Error Analysis}, 2nd ed. University Science Books, 1997.}
\bibitem{ref3} {\small PHYS 101 Laboratory Manual, Fall 2024. }
\end{thebibliography}
