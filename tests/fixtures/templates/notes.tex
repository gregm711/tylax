...
\begin{center}
\textbf{ MATH 301: Real Analysis }
\par\vspace{0.3em}
Lecture Notes - Week 5
\par\vspace{0.3em}
\textcolor[HTML]{666666}{ Prof. Jane Smith · Fall 2024 · Your University }
\par\vspace{0.3em}
\textit{ Notes by: Your Name · Last updated: "[month repr:long] [day], [year]" }
\end{center}
...
Sequence Sequence A \textbf{sequence} of real numbers is a function $a: \mathbb{N} \to \mathbb{R}$. We typically write $a_n$ for $a(n)$ and denote the sequence as $(a_n)_(n=1)^infinity$ or simply $(a_n)$.
...
Convergence Convergence A sequence $(a_n)$ \textbf{converges} to a limit $L \in \mathbb{R}$ if for every $\epsilon > 0$, there exists $N \in \mathbb{N}$ such that for all $n > N$: $|a_n - L| < \epsilon$ We write $\lim_(n \to infinity) a_n = L$ or $a_n \to L$.
...
Uniqueness of Limits Uniqueness of Limits If $(a_n)$ converges, then its limit is unique.
...
Algebraic Limit Theorem Algebraic Limit Theorem Let $(a_n) \to L$ and $(b_n) \to M$. Then:
...
Bounded Sequence Bounded Sequence A sequence $(a_n)$ is \textbf{bounded} if there exists $M > 0$ such that $|a_n| \le M$ for all $n \in \mathbb{N}$.
...
Monotone Sequence Monotone Sequence A sequence $(a_n)$ is:
