...
\begin{center}
 \textcolor{white}{University Name · Department of Computer Science}
\par\vspace{0.3em}
{\huge \textcolor{white}{\textbf{CS 301: Data Structures and Algorithms}}}
\par\vspace{0.3em}
{\large \textcolor{white}{Fall 2024 · 3 Credit Hours}} 
\end{center}
...
\begin{tabular}{cc}
 \subsection{Instructor Information} \textbf{Instructor:} Dr. Jane Smith \\ \textbf{Email:} jsmith@university.edu \\ \textbf{Office:} Engineering Building, Room 312 \\ \textbf{Office Hours:} Mon/Wed 2:00-4:00 PM \\ or by appointment \\ \textbf{Phone:} (555) 123-4567 &  \subsection{Course Details} \textbf{Lecture:} MWF 10:00-10:50 AM \\ \textbf{Location:} Science Hall 101 \\ \textbf{Lab:} Thursday 2:00-4:00 PM \\ \textbf{Lab Location:} CS Lab 205 \\ \textbf{Course Website:} canvas.university.edu \\ \textbf{Prerequisites:} CS 201, MATH 220 \\
\end{tabular}
\endgroup
...
\begin{tabular}{ccc}
\rowcolor{\tylaxHeaderRowColor} \textcolor{white}{\textbf{Component}} & \textcolor{white}{\textbf{Weight}} & \textcolor{white}{\textbf{Details}} \\
Programming Assignments & 35\% & 6 assignments, lowest dropped \\
Lab Exercises & 15\% & Weekly lab work and participation \\
Midterm Exam & 20\% & October 15, in class \\
Final Exam & 25\% & December 12, 8:00-10:00 AM \\
...
\hline
\rowcolor{\tylaxHeaderRowColor} \textcolor{white}{\textbf{Week}} & \textcolor{white}{\textbf{Date}} & \textcolor{white}{\textbf{Topics}} & \textcolor{white}{\textbf{Assignments}} \\
\hline
1 & Aug 26 & Introduction, Algorithm Analysis &  \\
\hline
2 & Sep 2 & Big-O, Arrays, Dynamic Arrays & HW1 out \\
\hline
3 & Sep 9 & Linked Lists, Stacks &  \\
\hline
4 & Sep 16 & Queues, Deques & HW1 due, HW2 out \\
\hline
5 & Sep 23 & Recursion, Binary Trees &  \\
\hline
6 & Sep 30 & BST, Tree Traversals & HW2 due, HW3 out \\
\hline
7 & Oct 7 & Balanced Trees (AVL, Red-Black) &  \\
\hline
8 & Oct 14 & \textbf{Midterm Review \& Exam} & HW3 due \\
\hline
9 & Oct 21 & Heaps, Priority Queues & HW4 out \\
\hline
10 & Oct 28 & Hash Tables, Collision Resolution &  \\
\hline
11 & Nov 4 & Graphs: Representation, BFS, DFS & HW4 due, HW5 out \\
\hline
12 & Nov 11 & Shortest Paths (Dijkstra, Bellman-Ford) &  \\
\hline
13 & Nov 18 & MST, Sorting Algorithms & HW5 due, HW6 out \\
\hline
14 & Nov 25 & \textit{Thanksgiving Break - No Class} &  \\
\hline
15 & Dec 2 & Dynamic Programming, Review & HW6 due \\
\hline
16 & Dec 9 & \textbf{Final Exam (Dec 12)} &  \\
\hline
\end{tabular}
\endgroup
...
\{ block( width: 100\%, fill: light, stroke: 0.5pt + accent, inset: 10pt, radius: 3pt, )[ \textcolor{primary}{\textbf{}}

Regular attendance is expected. More than 3 unexcused absences may result in a lowered participation grade. If you must miss class, please notify me in advance when possible.

] v(0.5em) \}

\{ block( width: 100\%, fill: light, stroke: 0.5pt + accent, inset: 10pt, radius: 3pt, )[ \textcolor{primary}{\textbf{}}

Assignments are due at 11:59 PM on the due date. Late submissions receive a 10\% penalty per day, up to 3 days. After 3 days, late work is not accepted. Extensions may be granted for documented emergencies.

] v(0.5em) \}

\{ block( width: 100\%, fill: light, stroke: 0.5pt + accent, inset: 10pt, radius: 3pt, )[ \textcolor{primary}{\textbf{}}

All submitted work must be your own. You may discuss concepts with classmates, but code and written answers must be individual work. Use of AI assistants (ChatGPT, Copilot, etc.) must be disclosed. Violations will be reported to the Dean of Students.
...
Students with disabilities should contact the Office of Disability Services to arrange appropriate accommodations. Please provide your accommodation letter within the first two weeks of class.
...
\begin{center}
{\footnotesize \textcolor{gray}{ \textit{This syllabus is subject to change. Students will be notified of any modifications.} \\ Last updated: November 28, 2024 · Made with TypeTeX · typetex.com }}
\end{center}
\end{document}
