...
\bibitem{ref1} {\small J. Smith, "Example paper title," in \textit{Proc. IEEE Conference}, 2023, pp. 1-10.}
\bibitem{ref2} {\small A. Jones and B. Williams, "Another example paper," \textit{IEEE Trans. on Computing}, vol. 42, no. 3, pp. 123-135, 2024. }
\end{thebibliography}
\end{document}
